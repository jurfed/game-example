...
@Reflect_Full
public class CustomPayTableScreenModel extends OPayTableScreenModel {
    ITranslator translator;
    private static final String FULL_SEVEN = "superSeven";
    @Inject
    public CustomPayTableScreenModel(ITranslator translator, ICreditsFormatter creditsFormatter, IEventBus eventBus, IPayTableModelProvider payTableModelProvider) {
